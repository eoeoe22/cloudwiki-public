* **{bi:github}** https://github.com/eoeoe22/cloudwiki-public
...
새로운 기여자이거나 시스템 구조를 자세히 파악하고 싶으시다면 [개발자 가이드](docs/developer-guide.md) 문서를 참고해주세요.
아키텍처, 데이터베이스 모델, 렌더링 파이프라인 등이 설명되어 있습니다.
