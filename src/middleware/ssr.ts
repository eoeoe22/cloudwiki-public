 ...
 */
export function applyPageSSR(response: Response, pageData: Record<string, any>, env: { WIKI_NAME?: string; WIKI_LOGO_URL?: string; WIKI_FAVICON_URL?: string; CUSTOM_HEADER?: string }, headerHtml: string = '', sidebarHtml: string = ''): Response {
    ...
    const rewriter = new HTMLRewriter()
        ...
        .on('meta[name="description"]', {
            element(element) {
                if (pageData._ssrDescription) {
                    element.setAttribute('content', pageData._ssrDescription);
                }
            }
        })
        ...
        .on('meta[property="og:title"]', {
            element(element) {
                if (pageData._ssrTitle) {
                    element.setAttribute('content', pageData._ssrTitle);
                }
            }
        })
